...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            TextView locationTextView = (TextView) findViewById(R.id.full_address);
            ...
            String url ="http://api.openweathermap.org/data/2.5/weather?q=" + city + "&APPID=6d6244d87fca1f39ed6ceabd98e41eb5";
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                String weatherCondition = weatherDetailsJsonObject.getString("description");
                                TextView weatherTextView = (TextView) findViewById(R.id.weather_conditions);
                                weatherTextView.setText(weatherCondition);

                                String MY_URL_STRING = "http://openweathermap.org/img/w/" + weatherDetailsJsonObject.getString("icon") + ".png";
    ...
    public void whattowear(View v) {
        Intent myIntent = new Intent(this, Main3Activity.class);
        myIntent.putExtra("weatherData", weatherData);
